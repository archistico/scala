let rapportoBlondelMedio = 63;
let rapportoBlondelMinimo = 62;
let rapportoBlondelMassimo = 64;
let alzataMinima = 15.0;
let alzataMassima = 20.0;
let pedataMinima = 24.0;
let pedataMassima = 32;
...
for(let tAlzata=alzataMinima; tAlzata<=alzataMassima; tAlzata += 0.05) {
    for(let tNumeroAlzate=1; tNumeroAlzate<=numeroMassimoAlzate; tNumeroAlzate++) {
        let scala = new Scala(tAlzata,Scala.calcolaPedata(tAlzata, rapportoBlondelMedio),tNumeroAlzate);
